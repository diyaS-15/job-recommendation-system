    ...
    return(
        <div className="relative bg-[url('/images/jobrecbg1.jpg')] bg-cover h-screen bg-opacity-10 flex items-center justify-center">
            <div className="rounded-lg bg-white bg-center shadow-xl content-center px-20 pt-10 pb-50">
                <h2 className="text-3xl m-5 text-center text-[#202526]">Login</h2>
                <form className="flex flex-col">
                    ...
                    <button className="rounded-lg bg-[#E0E1DD] mx-16 my-4 text-[#202526]" onClick={handelLoginClick}>Log in</button>
                </form>
                <p className="text-sm text-center text-[#202526]" onClick={handelSignupClick}>New? Sign Up</p>
            </div>
        </div>
    );
}